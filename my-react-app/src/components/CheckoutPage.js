    ...
    <div className="stepper-wrapper mb-5">
      <div className="stepper d-flex justify-content-between">
        {steps.map((step, index) => (
          ...
          >
            <div className="stepper-circle">{step.id}</div>
            ...
            <div className="card checkout-card">
              ...
              <div className="card-body">
                <form onSubmit={handleSurveySubmit}>
                  {['siteEase', 'siteDesign', 'siteSpeed', 'productQuality', 'productVariety', 'productPackaging'].map((key, idx) => (
                    <div className="mb-3" key={key}>
                      <label className="form-label">
                        {[
                          ...
                          'How would you rate the quality of our donuts?',
                          'How would you rate our product variety?',
                          'How would you rate our product packaging?'
                        ][idx]}
                      </label>
                      <select
                  ...
                  <div className="d-flex justify-content-between">
                    <button type="button" className="btn btn-outline-secondary" onClick={() => setShowSurvey(false)}>Back to Order</button>
        ...
        <div className="row justify-content-center">
          <div className="col-md-8 text-center">
            <div className="alert alert-warning">
              ...
              <button className="btn btn-primary mt-3" onClick={() => navigate('/')}>Browse Donuts</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="container my-5">
      ...
      <div className="row">
        <div className="col-md-8">
          {currentStep === 1 && (
            <div className="card mb-4 checkout-card">
              <div className="card-header bg-light"><h5>Personal Information</h5></div>
              <div className="card-body">
                <div className="mb-3">
                ...
                <div className="d-flex justify-content-end">
                  <button className="btn btn-primary" onClick={nextStep} disabled={!formData.name || !formData.email}>Next</button>
                </div>
              </div>
            </div>
          )}
          {currentStep === 2 && (
            <div className="card mb-4 checkout-card">
              <div className="card-header bg-light"><h5>Shipping Address</h5></div>
              <div className="card-body">
                <div className="mb-3">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <button className="btn btn-primary" onClick={nextStep} disabled={!formData.address || !formData.city || !formData.zipCode}>Next</button>
                </div>
              </div>
            </div>
          )}
          {currentStep === 3 && (
            <form onSubmit={handleSubmit}>
              <div className="card mb-4 checkout-card">
                <div className="card-header bg-light"><h5>Payment Information</h5></div>
                <div className="card-body">
                  <div className="mb-3">
                    <label className="form-label">Card Number</label>
                    <div className="form-control bg-light"><span className="text-muted">•••• •••• •••• 4242</span></div>
                    <small className="text-muted">Test card number displayed for demo purposes</small>
                  </div>
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      <label className="form-label">Expiry Date</label>
                      <div className="form-control bg-light"><span className="text-muted">04/24</span></div>
                    </div>
                    <div className="col-md-6 mb-3">
                      <label className="form-label">CVV</label>
                      <div className="form-control bg-light"><span className="text-muted">•••</span></div>
                    </div>
                  </div>
                  <div className="alert alert-info mt-3">
                    <i className="bi bi-info-circle me-2"></i>This is a demo store. No real payments are processed.
                  </div>
                </div>
              </div>
              <div className="d-flex justify-content-between">
            ...
            <div className="card mb-4 checkout-card">
              <div className="card-body text-center">
                <div className="alert alert-success">
                  ...
                  <button className="btn btn-primary mt-3" onClick={() => setShowSurvey(true)}>Take Our Survey</button>
                  <button className="btn btn-outline-secondary mt-3 ms-2" onClick={() => {
                    clearCart();
                    navigate('/');
                  }}>Skip Survey</button>
                </div>
        ...
        <div className="col-md-4">
          <div className="card checkout-card">
            <div className="card-header bg-light"><h5>Order Summary</h5></div>
            <div className="card-body">
